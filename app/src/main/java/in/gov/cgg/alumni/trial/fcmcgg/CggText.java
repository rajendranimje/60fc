...
public class CggText {
    ...
    public interface CggTextListener
    {
    ...
    private CggTextListener listener;
    private Response response;

    public CggText(String API_KEY) {
        this.listener = null;
        this.API_KEY = API_KEY;
    }

    public void setCggTextListener(CggTextListener listener)
    {
